...
/**
 * Demonstrates how to write a JUnit test that runs tests against Sauce Labs using multiple browsers in .
 * <p/>
...
public class TestBase implements SauceOnDemandSessionIdProvider {
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"Windows 10", "dev", "chrome", null, null});  
